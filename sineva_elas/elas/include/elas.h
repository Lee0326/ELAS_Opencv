...
private:
    ...
    vector<Vec6f> ComputeDelaunayTriangulation(const vector<Point3i> &support_points, const bool &right_image);
    ...
    void CreateGrid(const vector<Point3i> &support_points, Mat &disparity_grid, const Size &disparity_grid_size, bool right_image);
    void ComputeDisparity(const vector<Point3i> &support_points, const vector<Vec6f> &triangulate_points, const Mat &disparity_grid, const Size &disparity_grid_size, bool right_image, Mat &disparity);
    // parameter set
    parameters param_;
